...
png(file="C:/Users/NathanielSOON/Desktop/Coursera Data science/Exploratory data analysis/Programming Assignment 1/plot4.png")
par(mfrow=c(2,2))
with(data.new,plot(datetime,Global_active_power,xlab="",ylab="Global Active Power",type="l"))
with(data.new,plot(datetime,Voltage,ylab="Voltage",type="l"))
...
with(data.new,plot(datetime,Global_reactive_power,ylab="Global_reactive_power",type="l"))
dev.off()
